...
server: main.c connmgr.c sbuffer.c sensor_db.c datamgr.c lib/dplist.c lib/tcpsock.c
	gcc -g main.c connmgr.c sbuffer.c sensor_db.c datamgr.c lib/dplist.c lib/tcpsock.c -DMAX_CONN=3 -DSET_MIN_TEMP=10 -DSET_MAX_TEMP=20 -o server -lpthread

#sensor_node: sensor_node.c lib/tcpsock.c
#	gcc sensor_node.c lib/tcpsock.c -DLOOPS=20 -o sensor_node
